...
func main() {
	...
	http.HandleFunc("/action/status_funcionario", app.ActionStatusFuncionario)
	http.HandleFunc("/action/excluir_funcionario", app.ActionExcluirFuncionario)
	...
	http.HandleFunc("/page/configurar", app.PageConfigurar)
	http.HandleFunc("/action/adicionar_cargo", app.ActionAdicionarCargo)
	http.HandleFunc("/action/remover_cargo", app.ActionRemoverCargo)
	http.HandleFunc("/action/login_config", app.ActionLoginConfig)
	http.HandleFunc("/action/logout_config", app.ActionLogoutConfig)
	http.HandleFunc("/page/home/senha/", app.ActionUpdateSenhaGET)
	http.HandleFunc("/action/adicionar_produto", app.ActionAdicionarProduto)
	http.HandleFunc("/action/remover_produto", app.ActionRemoverProduto)
